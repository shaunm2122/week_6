...
function sendApiRequest(fetches) {
  
    fetch("https://api.giphy.com/v1/gifs/search?api_key=PhFg166r1nNNZlKe8wWk9fbCFBQTHvgr&q="+fetches+"&limit=25&offset=0&rating=G&lang=en")
        .then(function(data) {
      return data.json();
    })
    .then(function(json) {
